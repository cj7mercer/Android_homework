...
public class SecondActive extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if(!isCreate)
        {
            ...
            Cursor cursor = db.rawQuery("select content,name,author from diary where id = '"+index+"'",null);
        ...
        btn_sub.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                //新建页面
                    ...
                    db.execSQL("insert into diary(id,author,month,day,name,content) values("+id+",'"+text+"',"+month+","+day+",'"+name+"','"+content+"')");
